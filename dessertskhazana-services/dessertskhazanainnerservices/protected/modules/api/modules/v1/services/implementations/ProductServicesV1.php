                    ...
                    if(count($retAreaBasedConductProductTypeShopStoreDetailsArr) > 0 && $retAreaBasedConductProductTypeShopStoreDetailsArr != false) {
                        ...
                        if(count($sortedOnShopStoresDetailsArr)>0 && $sortedOnShopStoresDetailsArr!=false){
                            ...
                            if(count($retAllShopStoresProductTypeProductCategoryProductListArr)>0 && $retAllShopStoresProductTypeProductCategoryProductListArr!=false){
                                ...
                                $allProductTypeProductCategoryProductList = array();
                                $dashBoardLevelDefaultProductTypeSelected = array();
                                if(count($sortedOnProductTypeProductCategoryDetailsArr)>0 && $sortedOnProductTypeProductCategoryDetailsArr!=false){
                                    ...
                                    foreach ($sortedOnProductTypeProductCategoryDetailsArr as $eachProductTypeId => $productCategoryDetailsArr) {
                                        ...
                                        foreach ($productCategoryDetailsArr as $eachProductCategoryId => $productCateogryAllProductDetailsArr) {
                                            // remove unused keys from original array
                                            $removeJsonKeyFromEachInputJsonArr = array(
                                                "shopStoreLabel" => "0", "shopstore_mobile" => "0", "countryId" => "0",
                                                "cityId" => "0", "areaId" => "0", "areaTitle" => "0"
                                            );
                                            // original array
                                            $productDetailsArr = utils :: removeJsonKeyAndValuesFromArrayOfJsonArray($productCateogryAllProductDetailsArr, $removeJsonKeyFromEachInputJsonArr, 'keyname');
                                            // prepared array for each product type ka product category wise minimum 8 product list to show
                                            $eachProductTypeProductCategoryDetailsArr = array();
                                            $eachProductTypeProductCategoryDetailsArr['productTypeId'] = $eachProductTypeId;
                                            $eachProductTypeProductCategoryDetailsArr['productTypeTitle'] = $productDetailsArr[0]['productTypeTitleInCaps'];
                                            $eachProductTypeProductCategoryDetailsArr['isProductTypeIdMatched'] = 'Y';
                                            $eachProductTypeProductCategoryDetailsArr['productTypeCategoryId'] = $eachProductCategoryId;
                                            $eachProductTypeProductCategoryDetailsArr['productTypeProductCategoryTitle'] = strtoupper($productDetailsArr[0]['productTypeProductCategoryTitle']);
                                            $eachProductTypeProductCategoryDetailsArr['productCategoryTotalProductCount'] = count($productDetailsArr);
                                            ...
                                            $eachProductTypeProductCategoryDetailsArr['allProductDetails'] = $eachProductTypeAllProductDetailsArr;
                                            // decide product icon
                                            if (strtolower($eachProductTypeProductCategoryDetailsArr['productTypeTitle']) == 'cakes') {
                                                $eachProductTypeProductCategoryDetailsArr['productIcon'] = 'fa fa-birthday-cake';
                                            }
                                            array_push($allProductTypeProductCategoryProductList, $eachProductTypeProductCategoryDetailsArr);
                                        }
                                        $dashBoardLevelDefaultProductTypeSelected["isProductTypeIdMatched"] = "Y";
                                        $dashBoardLevelDefaultProductTypeSelected["matchedProductTypeId"] = $eachProductTypeId;
                                        $dashBoardLevelDefaultProductTypeSelected["matchedProductTypeTitle"] = $eachProductTypeProductCategoryDetailsArr['productTypeTitle'];
                                    }
                                }
                                // final checking 
                                if(count($allProductTypeProductCategoryProductList)>0 && $allProductTypeProductCategoryProductList!=false){
                                    ...
                                    if(count($dashBoardLevelDefaultProductTypeSelected)>0){
                                        $rspDetails["defaultSelectedProductTypeDetails"] = $dashBoardLevelDefaultProductTypeSelected;
                                    }
                                }
                            }
                        }
