    ...
    public static function getUserAllWLWiseItemDetails($paramJson=array()){
        ...
        try{
            ...
            $sql= " SELECT 
                    ...
                    COALESCE(u.state, '') userState,
                    COALESCE(u.city, '') userCity,
                    ...
                    COALESCE(ss.id, '') unMd5ShopStoreId, 
                    ss.shopstore_name shopStoreTitle,
                    MD5(wlm.product_typeid) productTypeId,
                    wlm.product_typeid unMD5ProductTypeId,
                    MD5(wlm.product_categoryid) productCateogoryId,
                    wlm.product_categoryid unMD5ProductCateogoryId,
                    wlm.product_categoryid unMD5ProductTypeProductCategoryId,
                    COALESCE(sppl.name, '') productListTitle,
                    MD5(wlm.product_listid) productListId,
                    wlm.product_listid unMd5ProductListId,
                    MD5(wlm.product_featureid) productFeatureId,
                    wlm.product_featureid unMd5ProductFeatureId,
