...
//globalBaseSitePath = 'http://192.168.1.107/dk-system/';
...
var deviceWidth1 = parseInt(window.screen.width);
var deviceHeight1 = parseInt(window.screen.height);
console.log("on load deviceWidth=>"+deviceWidth+", deviceHeight=>"+deviceHeight);
//alert("deviceWidth=>"+deviceWidth+", deviceHeight=>"+deviceHeight+", sdeviceWidth1=>"+deviceWidth1+", sdeviceHeight1=>"+deviceHeight1);
